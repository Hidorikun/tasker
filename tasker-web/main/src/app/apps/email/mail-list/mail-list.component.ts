...
export class MailListComponent implements OnInit {
  ...
  constructor(
    ...
    this.state.pipe(takeUntil(this.destroy$)).subscribe('markAsRead', () => {
      this.markAllAsRead();
    });

    this.state.pipe(takeUntil(this.destroy$)).subscribe('markAsUnRead', () => {
      this.markAllAsUnRead();
    });

    this.state.pipe(takeUntil(this.destroy$)).subscribe('deleteChecked', () => {
  ...
  public toggleAll() {
    ...
    this.mails?.pipe(takeUntil(this.destroy$)).subscribe(result => {
      result.forEach(mail => {
